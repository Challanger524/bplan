...
//constexpr inline auto API_PATH_GEN_BUD_DAT  = "generalData"    ;
constexpr inline auto API_PATH_LOC_BUD_DAT  = "localBudgetData";
...
enum                         item_e  : int { INCOMES ,  EXPANSES ,  CREDITS ,  FINANCING_DEBTS ,  FINANCING_CREDITOR }; // budget type
inline constexpr const char* items[] =     {"INCOMES", "EXPANSES", "CREDITS", "FINANCING_DEBTS", "FINANCING_CREDITOR"}; // budget type // c-array for imgui combo (drop list) api
